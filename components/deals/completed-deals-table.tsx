...
interface CompletedDealsTableProps {
  searchText: string
  yearFilter: string
  stageFilter: string
  pageSize: number
...
export function CompletedDealsTable({
  ...
  const loadCompletedDeals = async () => {
    ...
    try {
      ...
      console.error('Completed Deals Error:', e)
      setCompletedDeals([])
    } finally {
  ...
  // Load more completed deals
  const loadMoreCompletedDeals = async () => {
    ...
    try {
      ...
      console.error('Load More Completed Deals Error:', e)
    } finally {
  ...
  const filteredData = useMemo(() => {
    ...
    return filtered
  }, [searchText, yearFilter, stageFilter, completedDeals])
        ...
        <>
          ...
          {completedHasMore && (
            <div className="mt-6 text-center">
              <button
                onClick={loadMoreCompletedDeals}
